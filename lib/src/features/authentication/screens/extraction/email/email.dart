...
//   }
//
//   Future<void> _markAsSpam(String spamType) async {
//     if (_selectedEmail != null) {
//       final response = await _sendSpamDetailsToApi(spamType);
...
//       "email_body": _selectedEmail!.snippet,
//       "email_sender": _getSenderEmail(_selectedEmail!),
//       "email_user": _currentUser!.email,
//       "call_spam": spamType,
//       "user_auth_id": userId,
//     };
//
//     final response = // Send the POST request to the API
//
//     return response;
//   }